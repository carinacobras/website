...
class InvoiceItemsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_invoice_items_charge1' => ['type' => 'index', 'columns' => ['charge_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_invoice_items_charge1' => ['type' => 'foreign', 'columns' => ['charge_id'], 'references' => ['charges', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
