...
class InvoicesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'charges_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        '_indexes' => [
            ...
            'fk_invoices_charges1' => ['type' => 'index', 'columns' => ['charges_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_invoices_charges1' => ['type' => 'foreign', 'columns' => ['charges_id'], 'references' => ['charges', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
