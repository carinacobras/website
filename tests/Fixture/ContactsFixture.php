...
class ContactsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'players_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            ...
            'fk_players_id1' => ['type' => 'index', 'columns' => ['players_id'], 'length' => []],
        ],
        '_constraints' => [
            ...
            'fk_players_id1' => ['type' => 'foreign', 'columns' => ['players_id'], 'references' => ['players', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
